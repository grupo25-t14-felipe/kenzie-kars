...
const CardList = () => {
  return (
    <ul className="w-full md:w-[70%] flex overflow-auto md:flex-wrap relative h-full">
      <li className="px-4 py-8 flex flex-col gap-4 text-grey-1 min-w-[100%] md:min-w-[50%] lg:min-w-[33%] w-[100%] md:w-[50%] lg:w-[33%] ">
        <div>
          <Image className="w-full h-full" src={carIntro} alt="carro" />
        </div>
      ...
      <div className="w-full font-semibold md:flex flex-col items-center hidden">
